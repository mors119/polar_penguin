/**
 * ============================================================
 *  운영 데이터 초기화  ⚠ 시트 데이터는 되돌릴 수 없습니다
 * ============================================================
 *  주문·피킹 데이터와 운영 로그를 비워 재시험할 때 사용하는 관리자 도구다.
 *  기본 초기화는 상품 정보·보관위치·설정·통합 Input 처리 이력과 Drive 파일을
 *  유지하며, 상품마스터 전체 삭제는 별도 확인문구가 필요한 함수로 분리한다.
 * ============================================================
 */

/**
 * 실제 변경 없이 기본 초기화에서 삭제·유지할 대상을 표시한다.
 *
 * @return {string} 초기화 영향 범위 안내
 */
function 초기화_1_미리보기() {
  var out = ['=== 초기화하면 지워질 것 ===', ''];
...
/**
 * 상품마스터까지 전부 비운다. 상품 정보와 사용자가 관리한 보관위치도 사라진다.
 *
 * @param {string} 확인문구 반드시 "마스터까지초기화"를 넘겨야 실행된다.
 * @return {string} 전체 초기화 결과
 */
