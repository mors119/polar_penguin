 ...
 * ============================================================
 *  v4 변경
 *   · 헤더의 피킹담당자를 라인의 담당자로 자동 전파한다.
 *     헤더에 이름을 한 번 적으면 그 주문의 모든 라인에 이름이 채워진다.
 *   · 차감 대상이 가용재고 → 예약재고 (S3에서 이미 예약을 잡아뒀다)
 *   · 취소 시 예약을 풀어 가용재고로 되돌린다.
 *
 *  실행: [설정]의 폴링주기(분) 트리거(syncAndRefresh) + 메뉴 수동 실행
 * ============================================================
 */
